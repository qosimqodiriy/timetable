...
<template>
    <div class="flex flex-col gap-6">
        ...
        <div v-loading="_loading" class="border rounded-2xl overflow-hidden bg-white shadow-sm transition-all">
            ...
            <el-table :data="_items.content" style="width: 100%" row-key="id" :expand-row-keys="expandedRowKeys" :header-cell-style="{ background: '#f9fafb', color: '#111827', fontWeight: '600', height: '56px' }">
